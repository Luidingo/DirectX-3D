	...
	: size(width, height)
{
	...
	reflection = new Reflection(this); // 지금 만든 물(= 현재 객체) 자신을 연산의 대상, 반사의 주체로
...
void Water::MakeMesh()
{
	// 우선 물의 화면 효과를 보기 위해, 메쉬는 쿼드로 단순화해서 구현
	...
	vertices.emplace_back(left, 0, top, 0, 0); // x, y, z, u, v 순으로 축값 대입
